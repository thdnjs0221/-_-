...
public interface ResumeDAO {
	 ...
	 * @return
	 */
	public ResumeFileInfoVO selectResumeInfo(@Param("resumeNo") String resumeNo);
	 ...
	 * @return
	 */
	public int selectTotalRecord(PaginationInfo<ResumeFileInfoVO> paging);
	 ...
	 * @return
	 */
	public List<ResumeFileInfoVO> selectResumeList(PaginationInfo<ResumeFileInfoVO> paging);
	 ...
	 * @return
	 */
	public int insertResume(ResumeFileInfoVO resumeVO);
	 ...
	 * @return
	 */
	public int updateResume(ResumeFileInfoVO resumeVO);
	 ...
	 * @return
	 */
	public int deleteResume(ResumeFileInfoVO resumeVO);
}
