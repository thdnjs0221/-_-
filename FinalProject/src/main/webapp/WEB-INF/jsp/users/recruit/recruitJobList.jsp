...
<h1 class="recruit_hot_header swHeader">직업별 채용공고</h1>
...
<form id="searchForm" method="get">
	<input type="text" name="tjobCode"	readonly="readonly" placeholder="tjobCode" />
	<input type="text" name="jobCode" 	readonly="readonly" placeholder="tjobCode" />
