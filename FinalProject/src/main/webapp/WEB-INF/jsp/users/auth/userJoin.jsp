...
<!-- 								비밀번호확인  -->
								...
								<div class="item">
									...
									<div class="input_collect TypoBox">
										<input type="text" id="passCheck" name="tmp_cellnum"
								...
								<div class="item">
									...
									<div class="TypoBox">
										...
										<input type="text" name="users.usersNm" id="user_nm" value="${users.usersNm}"
								...
								<div class="item">
									...
									<div class="TypoBox">
										<input type="date" name="users.usersBir" id="birth_date" value="${users.usersBir}" 
									...
									<div class="agree_box">
										...
										<li>
											<div class="agree_desc">
												<div class="InpBox">
													<span class="Chk"> <input type="radio" class="check_mail" id="termsAgree" name="users.usersGen" value="M"> <label class="Lbl check_custom check_off" for="termsAgree">
															<span>남자</span>
													</label>
													</span>
												</div>
										...
										<li>
											<div class="agree_desc">
												<div class="InpBox">
													<span class="Chk"> <input type="radio" id="sms_receive_fl" name="users.usersGen" value="F">
								...
								<li class="item identify_phone"><label for="sms_email_id"><strong>이메일</strong></label>
									<div class="TypoBox">
										<input type="text" id="sms_email_id" name="memMail" value="${member.memMail}"
								...
								<div class="item adress_column" id="address_area">
									...
									<div class="input_collect TypoBox">
										<input name="memZip" id="address_zip" type="text" value="${member.memZip}"
											class="Typo SizeL defalt from_address _searchArea"
											maxlength="" autocapitalize="off" autocomplete="off"
											placeholder="우편번호">
									</div>
									<div class="input_collect TypoBox">
										<input name="memAddr1" id="address_main" type="text"  value="${member.memAddr1}"
											class="Typo SizeL defalt from_address _searchArea"
											maxlength="" autocapitalize="off" autocomplete="off"
											placeholder="주소찾기">
									...
									<div class="TypoBox input_sebu_address">
										<input name="memAddr2" id="address_sebu" type="text" value="${member.memAddr2}"
