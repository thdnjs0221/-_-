	...
	if (confirm("정말 삭제하시겠습니까?") == true) {
		$.ajax({
	        ...
	        success:function(resp){
	        	...
	        	if(resp=="OK"){
	        		//임시로 사용자 리스트로..
	        		location.href="<%=request.getContextPath()%>/recruit/region";
	        	}else{
...
//    $.ajax({
//       type:"post",
<%--       url:"<%=request.getContextPath()%>/apply/${recruit.rcrtNo}/applyInsert", --%>
//       contentType:"application/json;charset=UTF-8",
//       dataType:"json",
//       data: JSON.stringify(applyVO),
//       success:function(resp){
//          //resp =JSON.parse(resp)
//          console.log("모달확인:",resp)
